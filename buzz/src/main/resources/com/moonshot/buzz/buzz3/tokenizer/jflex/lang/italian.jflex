...
R_LOVE = [Aa][Aa]+[Mm]+[Oo]+[Rr]*[Ee]*|[Aa]+[Mm][Mm]+[Oo]+[Rr]*[Ee]*|[Aa]+[Mm]+[Oo][Oo]+[Rr]*[Ee]*|[Aa]+[Mm]+[Oo]+[Rr][Rr]+[Ee]+|[Aa]+[Mm]+[Oo]+[Rr]+[Ee][Ee]+
R_YES = [Ss][Ss]+[IiÌì]+|[Ss]+[IiÌì][IiÌì]+
R_ARGH = [Aa]+[Rr]+[GgHh]+
...
// apostrophes are replaced with chmodelpunc

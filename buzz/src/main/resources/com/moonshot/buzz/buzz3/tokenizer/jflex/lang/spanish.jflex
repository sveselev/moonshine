...
R_LOVE = [Aa][Aa]+[Mm]+[AaOo]+[Rr]+|[Aa]+[Mm][Mm]+[AaOo]+[Rr]+|[Aa]+[Mm]+[AaOo][AaOo]+[Rr]+|[Aa]+[Mm]+[AaOo]+[Rr][Rr]+|[Aa]+[Mm]+[Oo]+[Rr]+[Ee][Ee]+|[Aa]+[Mm]+[Oo]+[Rr]+[Ee]+[Ss][Ss]+
R_LOVE2 = [Tt][Qq]|[Tt][Qq][Mm]
[Ll][Ll]+[Oo]+[Vv]+[Ee]+[Ss]*|[Ll]+[Oo][Oo]+[Vv]+[Ee]+[Ss]*|[Ll]+[Oo]+[Vv][Vv]+[Ee]+[Ss]*|[Ll]+[Oo]+[Vv]+[Ee][Ee]+[Ss]*|[Ll]+[Oo]+[Vv]+[Ee]+[Ss][Ss]+
R_YES = [Ss][Ss]+[IiÌìÍí]+|[Ss]+[IiÌìÍí][IiÌìÍí]+
R_ARGH = [Aa]+[Rr]+[GgHh]+
...
{R_LOVE2} { return JflexBuzzTokenizer.LOVE;}

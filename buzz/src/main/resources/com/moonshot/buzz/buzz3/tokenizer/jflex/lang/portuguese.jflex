...
%public
%final
%class JflexBuzzPortugueseLexer
...
R_HAHA = [Kk][Kk][Kk]+|[Rr]+[Ss]+|([Mm][Uu][Aa])?(([Hh][Aa])|([Aa]+[Hh]+|[Hh]+[Aa]+)[HhAa]+)
R_OMG = [Oo]+[Mm]+[Ff]*[Gg]+|[Mm]+[Ee]+[Ll]+[Dd]+[Ee]+[Ll]+[Ss]+
...
R_LOVE = [Aa][Aa]+[Mm]+[Oo]+[Rr]*|[Aa]+[Mm][Mm]+[Oo]+[Rr]*|[Aa]+[Mm]+[Oo][Oo]+[Rr]*|[Aa]+[Mm]+[Oo]+[Rr][Rr]+
R_YEAH = [Yy][Yy]+[Ee]+[Aa]+[Hh]+|[Yy]+[Ee][Ee]+[Aa]+[Hh]+|[Yy]+[Ee]+[Aa][Aa]+[Hh]+|[Yy]+[Ee]+[Aa]+[Hh][Hh]+
R_YES = [Ss][Ss]+[Ii]+[Mm]+|[Ss]+[Ii][Ii]+[Mm]+|[Ss]+[Ii]+[Mm][Mm]+
R_ARGH = [Aa]+[Rr]+[GgHh]+
R_LMAO = [Ll]+[Mm]+[Ff]*[Aa]+[Oo]+
R_HEHE = [Hh][Ee][HhEe]+
R_KISSES = [Bb]+[Jj]+[Oo]+[Ss]*

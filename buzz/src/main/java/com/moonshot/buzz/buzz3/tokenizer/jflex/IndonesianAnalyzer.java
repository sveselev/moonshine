...
import com.moonshot.buzz.buzz3.tokenizer.jflex.lang.JflexBuzzIndonesianLexer;
...
public class IndonesianAnalyzer extends BuzzAnalyzer {
    public static final IndonesianAnalyzer INSTANCE = new IndonesianAnalyzer();
    ...
    Function<Reader, JflexLexer> createScanner() {
        return JflexBuzzIndonesianLexer::new;
    }
